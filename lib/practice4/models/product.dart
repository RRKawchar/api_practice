...
enum CategoryName { CAT_BEDS, CAT_ITEMS, DOG_CLOTHING_AMP_SHOES, DOG_ITEMS }

final categoryNameValues = EnumValues({
  "Cat Beds": CategoryName.CAT_BEDS,
  "Cat Items": CategoryName.CAT_ITEMS,
  "Dog Clothing &amp; Shoes": CategoryName.DOG_CLOTHING_AMP_SHOES,
  "Dog Items": CategoryName.DOG_ITEMS
});

enum Slug { CAT_BEDS, CAT_ITEMS, DOG_CLOTHING_SHOES, DOG_ITEMS }

final slugValues = EnumValues({
  "cat-beds": Slug.CAT_BEDS,
  "cat-items": Slug.CAT_ITEMS,
  "dog-clothing-shoes": Slug.DOG_CLOTHING_SHOES,
  "dog-items": Slug.DOG_ITEMS
});
...
class DefaultAttribute {
  ...
  factory DefaultAttribute.fromJson(Map<String, dynamic> json) => DefaultAttribute(
    id: json["id"],
    name: defaultAttributeNameValues.map![json["name"]],
    option: json["option"],
  );

  Map<String, dynamic> toJson() => {
    "id": id,
    "name": defaultAttributeNameValues.reverse![name],
    "option": option,
  };
}

enum DefaultAttributeName { COLOR, SIZE, SHIPS_FROM }

final defaultAttributeNameValues = EnumValues({
  "Color": DefaultAttributeName.COLOR,
  "Ships From": DefaultAttributeName.SHIPS_FROM,
  "Size": DefaultAttributeName.SIZE
});
